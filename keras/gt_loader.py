...
def load_gt(image_path, num_classes, gt_loader=load_gt_multihot_bit_indexed_png, dontcare_idx=-1, use_disk_cache=True, memory_cache=None, compress_in_ram=False, downsampling_rate=1.0, debuglevel=0):
