...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=5, metavar='N', help='input batch size for training (default: 4)')
    parser.add_argument('--num_classes', type=int, default=5, metavar='N', help='number of classes (default: 4)')
    parser.add_argument('--epochs', type=int, default=10, metavar='N', help='number of epochs to train (default: 40)')
    parser.add_argument('--steps_per_epoch', type=int, default=5000, metavar='N', help='number of epochs to train (default: 40)')
    ...
    parser.add_argument('--model_save_interval', type=int, default=10000, help='Number of batches between model saves')
